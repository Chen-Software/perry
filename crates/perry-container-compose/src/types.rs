...
/// Each dependency entry in the object-form depends_on
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Volume mount types (compose-spec §service.volumes[].type)
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum VolumeType {
    Bind,
...
/// Ports can be short strings/numbers or long-form objects
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PortSpec {
...
/// Service network attachment configuration
...
/// The networks field on a service: list or map
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// Root compose specification (compose-spec §root)
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
/// Opaque handle returned by composeUp representing a running stack.
#[derive(Debug, Clone, Serialize, Deserialize)]
