  ...
  services: {
    ...
    forgejo: {
      ...
      environment: {
        ...
        // FORGEJO__mailer__HOST: '${SMTP_HOST:-smtp.example.com:587}',
        // FORGEJO__mailer__USER: '${SMTP_USER:-noreply@example.com}',
        // FORGEJO__mailer__PASSWD: '${SMTP_PASSWORD:-}',
        // FORGEJO__mailer__FROM: '${SMTP_FROM:-noreply@example.com}',
      },
      volumes: [
        'forgejo-data:/data',
