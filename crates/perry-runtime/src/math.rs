...
/// Math.hypot(a, b) -> number (hypotenuse)
#[no_mangle]
...
/// Math.clz32(x) -> number (count leading zeros in 32-bit integer)
#[no_mangle]
pub extern "C" fn js_math_clz32(x: f64) -> f64 { (x as i32 as u32).leading_zeros() as f64 }

/// Math.expm1(x) -> number (exp(x) - 1, accurate near zero)
#[no_mangle]
pub extern "C" fn js_math_expm1(x: f64) -> f64 { x.exp_m1() }

/// Math.log1p(x) -> number (log(1 + x), accurate near zero)
#[no_mangle]
...
/// Math.asinh(x) -> number (inverse hyperbolic sine)
#[no_mangle]
pub extern "C" fn js_math_asinh(x: f64) -> f64 { x.asinh() }

/// Math.acosh(x) -> number (inverse hyperbolic cosine)
#[no_mangle]
pub extern "C" fn js_math_acosh(x: f64) -> f64 { x.acosh() }

/// Math.atanh(x) -> number (inverse hyperbolic tangent)
#[no_mangle]
