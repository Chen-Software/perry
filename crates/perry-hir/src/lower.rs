                        ...
                        if is_native {
                            ...
                            let ffi_name = match source.as_str() {
                                ...
                                "perry/workloads" => match imported.as_str() {
                                    ...
                                    "handleDown" => Some("js_workload_handle_down"),
                                    "handleStatus" => Some("js_workload_handle_status"),
                                    "handleGraph" => Some("js_workload_handle_graph"),
                                    "handleLogs" => Some("js_workload_handle_logs"),
                                    "handleExec" => Some("js_workload_handle_exec"),
                                    "handlePs" => Some("js_workload_handle_ps"),
                                    _ => None,
                                },
                                _ => None,
                            };
