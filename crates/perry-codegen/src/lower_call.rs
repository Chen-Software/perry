...
enum NativeArgKind {
    ...
    F64,
    /// NaN-boxed object → serialize to JSON string and pass raw i64 pointer.
    Json,
...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: true, method: "logs",
        class_filter: Some("ComposeHandle"),
        runtime: "js_container_compose_logs", args: &[NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: true, method: "exec",
        class_filter: Some("ComposeHandle"),
        runtime: "js_container_compose_exec", args: &[NA_STR, NA_JSON, NA_JSON, NA_STR], ret: NR_PTR },

    // ========== perry/workloads ==========
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "runGraph",
        class_filter: None,
        runtime: "js_workload_run_graph", args: &[NA_JSON, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "inspectGraph",
        class_filter: None,
        runtime: "js_workload_inspect_graph", args: &[NA_JSON], ret: NR_PTR },
];
...
fn lower_native_module_dispatch(
    ...
    for (i, arg) in args.iter().enumerate() {
        ...
        match kind {
            ...
            NativeArgKind::Json => {
                let blk = ctx.block();
                let json_box = blk.call(DOUBLE, "js_json_stringify", &[(DOUBLE, &lowered)]);
