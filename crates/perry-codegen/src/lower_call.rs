...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "exec",
        class_filter: None,
        runtime: "js_container_exec", args: &[NA_STR, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "stop",
        class_filter: None,
        runtime: "js_container_stop", args: &[NA_STR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container-compose", has_receiver: true, method: "status",
        class_filter: Some("ComposeHandle"),
        runtime: "js_container_compose_status", args: &[], ret: NR_PTR },
