...
enum NativeArgKind {
    ...
    JsvalI64,
    /// Stringify an object/array arg to JSON and pass as StringHeader ptr (i64).
    JsonStr,
}
...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "stop",
        class_filter: None,
        runtime: "js_container_stop", args: &[NA_STR, NA_PTR], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "remove",
        class_filter: None,
        runtime: "js_container_remove", args: &[NA_STR, NA_PTR], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "list",
        class_filter: None,
        runtime: "js_container_list", args: &[NA_PTR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "logs",
        class_filter: None,
        runtime: "js_container_logs", args: &[NA_STR, NA_PTR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "removeImage",
        class_filter: None,
        runtime: "js_container_removeImage", args: &[NA_STR, NA_PTR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/compose", has_receiver: false, method: "down",
        class_filter: None,
        runtime: "js_compose_down", args: &[NA_PTR, NA_PTR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/compose", has_receiver: false, method: "logs",
        class_filter: None,
        runtime: "js_compose_logs", args: &[NA_PTR, NA_STR, NA_PTR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/compose", has_receiver: false, method: "start",
        class_filter: None,
        runtime: "js_compose_start", args: &[NA_PTR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/compose", has_receiver: false, method: "stop",
        class_filter: None,
        runtime: "js_compose_stop", args: &[NA_PTR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/compose", has_receiver: false, method: "restart",
        class_filter: None,
        runtime: "js_compose_restart", args: &[NA_PTR, NA_JSON], ret: NR_PTR },
];
    ...
    for (i, arg) in args.iter().enumerate() {
        ...
        match kind {
            ...
            NativeArgKind::JsonStr => {
                ...
                let json_handle = blk.call(I64, "js_json_stringify", &[(DOUBLE, &lowered), (I32, "0")]);
                // Box as string so unbox_to_i64 below gets the ptr bits.
                let json_box = nanbox_string_inline(blk, &json_handle);
                let json_ptr = blk.call(I64, "js_get_string_pointer_unified", &[(DOUBLE, &json_box)]);
