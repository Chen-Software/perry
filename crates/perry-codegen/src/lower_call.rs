...
static PERRY_CONTAINER_TABLE: &[UiSig] = &[
    ...
    UiSig { method: "composeUp", runtime: "js_container_compose_up", args: &[UiArgKind::Str], ret: UiReturnKind::Promise },
];
...
static PERRY_COMPOSE_TABLE: &[UiSig] = &[
    UiSig { method: "up", runtime: "js_container_compose_up", args: &[UiArgKind::Str], ret: UiReturnKind::Promise },
