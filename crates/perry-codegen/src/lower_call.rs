...
enum NativeArgKind {
    ...
    JsvalI64,
    /// Numeric arg the runtime wants as a raw i64 (e.g. enum tag, boolean
    /// flag, timeout). `fptosi` converts the f64 double to a signed 64-bit
    /// integer. Matches `UiArgKind::I64Raw`.
    I64Raw,
}
...
const NA_I64R: NativeArgKind = NativeArgKind::I64Raw;
...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "stop",
        class_filter: None, runtime: "js_container_stop", args: &[NA_STR, NA_I64R], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "remove",
        class_filter: None, runtime: "js_container_remove", args: &[NA_STR, NA_I64R], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "list",
        class_filter: None, runtime: "js_container_list", args: &[NA_I64R], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "logs",
        class_filter: None, runtime: "js_container_logs", args: &[NA_STR, NA_I64R], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "removeImage",
        class_filter: None, runtime: "js_container_removeImage", args: &[NA_STR, NA_I64R], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "removeIfExists",
        class_filter: None, runtime: "js_container_removeIfExists", args: &[NA_STR, NA_I64R], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container-compose", has_receiver: false, method: "logs",
        class_filter: None, runtime: "js_container_compose_logs", args: &[NA_PTR, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/container-compose", has_receiver: false, method: "exec",
        class_filter: None, runtime: "js_container_compose_exec", args: &[NA_PTR, NA_STR, NA_STR, NA_STR], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/compose", has_receiver: false, method: "logs",
        class_filter: None, runtime: "js_compose_logs", args: &[NA_PTR, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/compose", has_receiver: false, method: "exec",
        class_filter: None, runtime: "js_compose_exec", args: &[NA_PTR, NA_STR, NA_STR, NA_STR], ret: NR_PTR },
