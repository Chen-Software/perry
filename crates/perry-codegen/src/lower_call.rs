...
enum NativeArgKind {
    ...
    JsvalI64,
    /// NaN-boxed JSValue → JSON stringify it before passing the raw
    /// StringHeader pointer to the runtime. Used for container/compose
    /// specifications where the TypeScript side passes an object literal
    /// but the FFI expects a serialized JSON string.
    JsonStr,
    /// Numeric arg the runtime wants as i32. `fptosi` converts the f64 to i32.
    I32,
    /// Numeric arg the runtime wants as i64. `fptosi` converts the f64 to i64.
    I64,
}
...
const NA_JSON: NativeArgKind = NativeArgKind::JsonStr;
...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "build",
        class_filter: None,
        runtime: "js_container_build", args: &[NA_JSON, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "run",
        class_filter: None,
        runtime: "js_container_run", args: &[NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "create",
        class_filter: None,
        runtime: "js_container_create", args: &[NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "stop",
        class_filter: None,
        runtime: "js_container_stop", args: &[NA_STR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "remove",
        class_filter: None,
        runtime: "js_container_remove", args: &[NA_STR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "list",
        class_filter: None,
        runtime: "js_container_list", args: &[NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "logs",
        class_filter: None,
        runtime: "js_container_logs", args: &[NA_STR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: false, method: "exec",
        class_filter: None,
        runtime: "js_container_exec", args: &[NA_STR, NA_JSON, NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: true, method: "down",
        ...
        runtime: "js_compose_down", args: &[NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/container", has_receiver: true, method: "logs",
        class_filter: Some("ComposeHandle"),
        runtime: "js_compose_logs", args: &[NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/container", has_receiver: true, method: "exec",
        class_filter: Some("ComposeHandle"),
        runtime: "js_compose_exec", args: &[NA_STR, NA_JSON, NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "graph",
        class_filter: None,
        runtime: "js_workload_graph", args: &[NA_STR, NA_JSON], ret: NR_STR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "node",
        class_filter: None,
        runtime: "js_workload_node", args: &[NA_STR, NA_JSON], ret: NR_STR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "runGraph",
        class_filter: None,
        runtime: "js_workload_runGraph", args: &[NA_STR, NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/workloads", has_receiver: true, method: "down",
        class_filter: Some("GraphHandle"),
        runtime: "js_workload_handle_down", args: &[NA_JSON], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/workloads", has_receiver: true, method: "graph",
        class_filter: Some("GraphHandle"),
        runtime: "js_workload_handle_graph", args: &[], ret: NR_STR },
    NativeModSig { module: "perry/workloads", has_receiver: true, method: "logs",
        class_filter: Some("GraphHandle"),
        runtime: "js_workload_handle_logs", args: &[NA_STR, NA_JSON], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: true, method: "exec",
        class_filter: Some("GraphHandle"),
        runtime: "js_workload_handle_exec", args: &[NA_STR, NA_JSON, NA_JSON], ret: NR_PTR },
...
fn lower_native_module_dispatch(
    ...
    for (i, arg) in args.iter().enumerate() {
        ...
        match kind {
            ...
            NativeArgKind::JsonStr => {
                // Serialize JSValue to JSON string first.
                let blk = ctx.block();
                let zero = "0".to_string();
                let str_handle = blk.call(I64, "js_json_stringify", &[(DOUBLE, &lowered), (I32, &zero)]);
                // Extract raw StringHeader* from the handle.
                let boxed = nanbox_pointer_inline(blk, &str_handle);
                let ptr = blk.call(I64, "js_get_string_pointer_unified", &[(DOUBLE, &boxed)]);
                llvm_args.push((I64, ptr));
                arg_types.push(I64);
            }
            NativeArgKind::I32 => {
    ...
    for i in args.len()..sig.args.len() {
        match sig.args[i] {
            ...
            NativeArgKind::StrPtr | NativeArgKind::PtrI64 | NativeArgKind::JsvalI64 | NativeArgKind::JsonStr | NativeArgKind::I64 => {
