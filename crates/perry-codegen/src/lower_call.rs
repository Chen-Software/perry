...
enum NativeArgKind {
    ...
    JsvalI64,
    /// NaN-boxed double → truncate to i32 via fptosi.
    I32,
    /// NaN-boxed double → truncate to i64 via fptosi.
    I64,
}
...
const NATIVE_MODULE_TABLE: &[NativeModSig] = &[
    ...
    NativeModSig { module: "perry/container", has_receiver: false, method: "exec",
        class_filter: None,
        runtime: "js_container_exec", args: &[NA_STR, NA_STR, NA_STR], ret: NR_PTR },
    ...
    // ========== perry/container-compose (perry/compose alias) ==========
    ...
    NativeModSig { module: "perry/container-compose", has_receiver: false, method: "graph",
        class_filter: None,
        runtime: "js_container_compose_graph", args: &[NA_I64], ret: NR_STR },
    NativeModSig { module: "perry/container-compose", has_receiver: false, method: "status",
        class_filter: None,
        runtime: "js_container_compose_status", args: &[NA_I64], ret: NR_PTR },
    ...
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handleDown",
        class_filter: None,
        runtime: "js_workload_handle_down", args: &[NA_F64, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handleStatus",
        class_filter: None,
        runtime: "js_workload_handle_status", args: &[NA_F64], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handleGraph",
        class_filter: None,
        runtime: "js_workload_handle_graph", args: &[NA_F64], ret: NR_STR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handleLogs",
        class_filter: None,
        runtime: "js_workload_handle_logs", args: &[NA_F64, NA_STR, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handleExec",
        class_filter: None,
        runtime: "js_workload_handle_exec", args: &[NA_F64, NA_STR, NA_STR], ret: NR_PTR },
    NativeModSig { module: "perry/workloads", has_receiver: false, method: "handlePs",
        class_filter: None,
